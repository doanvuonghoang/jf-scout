...
public class PermissionManagementSearchFormData extends AbstractFormData {

  private static final long serialVersionUID = 1L;

  public PermissionManagementSearchFormData() {
  }

  public PermissionName getPermissionName() {
    return getFieldByClass(PermissionName.class);
  }

  public static class PermissionName extends AbstractValueFieldData<String> {
